package com.example.IPL_Dashboard.data;
...
public class MatchInput {
    ...
    public String getNeutral_venu() {
        return neutral_venu;
    }

    public void setNeutral_venu(String neutral_venu) {
        this.neutral_venu = neutral_venu;
    }
